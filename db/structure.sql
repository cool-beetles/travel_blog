...
CREATE TABLE "travels" ("id" integer NOT NULL PRIMARY KEY, "user_id" integer DEFAULT NULL, "city_name" varchar DEFAULT NULL, "description" varchar DEFAULT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "travel_date" date DEFAULT NULL);
